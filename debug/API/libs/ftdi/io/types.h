...
#define IAS_ZONE_ENROLL_NONE                                             0
#define IAS_ZONE_ENROLL_ZONE_TYPE_READ                                   1
#define IAS_ZONE_ENROLL_CIE_ADDR_SENT                                    2
#define IAS_ZONE_ENROLL_CIE_ADDR_WAIT_FOR_RESPONSE                       3
...
typedef struct 
{
	...
	uint8_t zoneEnrollState; //relevant only for IAS Zone devices
	uint8_t zoneId; //relevant only for IAS Zone devices
	uint32_t ZoneEnrollSequenceNumber; //relevant only for IAS Zone devices
...
typedef struct {
	...
	uint8_t finding_and_binding_time;
} network_info_t;
