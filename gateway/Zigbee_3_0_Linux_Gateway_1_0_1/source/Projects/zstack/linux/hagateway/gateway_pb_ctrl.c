...
const pb_pointers_entry _gateway_pb_pointers_list[] =
{
 ...
 {&dev_pxhoang_enroll_rsp__descriptor,		         (pb__unpack)dev_pxhoang_enroll_rsp__unpack,	           (pb__free_unpacked)dev_pxhoang_enroll_rsp__free_unpacked,	   GW_CMD_ID_T__DEV_PXHOANG_ENROLL_REQ},
};
